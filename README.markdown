...
3. [Setup - The basics of getting started with puppet-aspnet](#setup)
    * [What puppet-aspnet affects](#what-puppet-aspnet-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with puppet-aspnet](#beginning-with-puppet-aspnet)
